...
# chemin vers les fichiers où sont sauvegarder les données de proba
fichierProba = 'proba.pk'
fichierProba2 = 'proba2.pkl'
fichierProbaPremiereLettre = 'probaPremiereLettre.pkl'
...
if os.path.exists(fichierProba) and os.path.exists(fichierProba2) and os.path.exists(fichierProbaPremiereLettre):
    with open(fichierProba, 'rb') as fichier:
        proba = pickle.load(fichier)
    with open(fichierProba2, 'rb') as fichier:
        proba2 = pickle.load(fichier)
    with open(fichierProbaPremiereLettre, 'rb') as fichier:
        probaPremiereLettre = pickle.load(fichier)
else:
    ...
    with open(fichierProba, 'wb') as fichier:
        pickle.dump(proba, fichier)
    with open(fichierProba2, 'wb') as fichier:
        pickle.dump(proba2, fichier)
    with open(fichierProbaPremiereLettre, 'wb') as fichier:
        pickle.dump(probaPremiereLettre, fichier)
